...
import com.rackluxury.timber.dataloaders.AlbumLoader;
import com.rackluxury.timber.dataloaders.AlbumSongLoader;
import com.rackluxury.timber.dataloaders.ArtistAlbumLoader;
import com.rackluxury.timber.dataloaders.ArtistLoader;
import com.rackluxury.timber.dataloaders.ArtistSongLoader;
import com.rackluxury.timber.dataloaders.PlaylistLoader;
import com.rackluxury.timber.dataloaders.PlaylistSongLoader;
import com.rackluxury.timber.dataloaders.SongLoader;
import com.rackluxury.timber.models.Album;
import com.rackluxury.timber.models.Artist;
import com.rackluxury.timber.models.Playlist;
import com.rackluxury.timber.models.Song;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "rackluxury.timber/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "rackluxury.timber/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "rackluxury.timber/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "rackluxury.timber/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
