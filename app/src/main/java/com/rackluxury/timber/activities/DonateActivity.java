...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    private static final String DONATION_1 = "rackluxury.timber.donate_1";
    private static final String DONATION_2 = "rackluxury.timber.donate_2";
    private static final String DONATION_3 = "rackluxury.timber.donate_3";
    private static final String DONATION_5 = "rackluxury.timber.donate_5";
    private static final String DONATION_10 = "rackluxury.timber.donate_10";
    private static final String DONATION_20 = "rackluxury.timber.donate_20";
